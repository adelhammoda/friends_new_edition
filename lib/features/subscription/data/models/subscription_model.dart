...
class SubscriptionModel extends SubscriptionEntity {
  ...
  factory SubscriptionModel.fromJson(Map json){
    return SubscriptionModel(id: json[ConstantManager.subscriptionID],
        name: json[ConstantManager.subscriptionName],
        imageUrl: json[ConstantManager.subscriptionImageUrl],
        borderColor: json[ConstantManager.subscriptionBorderColor],
        endDate: json[ConstantManager.subscriptionEndDate],
        startDate: json[ConstantManager.subscriptionStartDate],
        backGroundColor: json[ConstantManager.subscriptionBackGroundColor],
        currency: json[ConstantManager.subscriptionCurrency],
        price: json[ConstantManager.subscriptionPrice],
